...
export async function POST(request:Request){
  try{
    ...
    const task:Task={id:"task_"+Date.now(),agentId:incident.agentId||"printshop-engineer",targetId:incident.targetId,title:incident.summary,type:"incident",priority:incident.severity==="high"?"urgent":"normal",status:"queued",fingerprint:fp,createdAt:now,updatedAt:now};
